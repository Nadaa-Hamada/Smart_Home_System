...
static constexpr auto qt_meta_stringdata_CLASSSerialReaderENDCLASS = QtMocHelpers::stringData(
    "SerialReader",
    "newData",
    "",
    "temp",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSerialReaderENDCLASS_t qt_meta_stringdata_CLASSSerialReaderENDCLASS = {
    {
        QT_MOC_LITERAL(0, 12),  // "SerialReader"
        QT_MOC_LITERAL(13, 7),  // "newData"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 4),  // "temp"
        QT_MOC_LITERAL(27, 5),  // "light"
...
void SerialReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newData((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        ...
        {
            using _t = void (SerialReader::*)(int , int );
            if (_t _q_method = &SerialReader::newData; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialReader::newData(int _t1, int _t2)
{
